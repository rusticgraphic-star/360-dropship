...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 antialiased">
      ...
      <a
        href={`https://wa.me/${(adminSettings.whatsappNumber || '919876543210').replace(/[^0-9]/g, '')}?text=Hello%20360%20Dropship%20Support%2C%20I%20need%20help%20with%20my%20account.`}
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-emerald-500 hover:bg-emerald-600 text-white p-3.5 sm:px-4 sm:py-3 rounded-full shadow-2xl flex items-center gap-2.5 transition-all hover:scale-105 group border-2 border-white/20"
      ...
      >
        ...
        <span className="font-extrabold text-xs hidden sm:inline group-hover:inline">WhatsApp Support</span>
